...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19065__auto__,writer__19066__auto__,opt__19067__auto__){
return cljs.core._write.call(null,writer__19066__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__19951 = o;
(G__19951[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__19952__delegate = function (args){
...
while (G__19953__i < G__19953__a.length) {G__19953__a[G__19953__i] = arguments[G__19953__i + 0]; ++G__19953__i;}
  args = new cljs.core.IndexedSeq(G__19953__a,0);
} 
return G__19952__delegate.call(this,args);};
...
return G__19952__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__18447__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__18447__auto__){
var and__18447__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18447__auto____$1){
var and__18447__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__19959 = jsprops;
(G__19959["defaultValue"] = value);

(G__19959["onChange"] = ((function (G__19959,v,value,on_change){
return (function (p1__19957_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19957_SHARP_);
});})(G__19959,v,value,on_change))
);
...
var vec__19964 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__19964,(0),null);
var id = cljs.core.nth.call(null,vec__19964,(1),null);
var class$ = cljs.core.nth.call(null,vec__19964,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___19967 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___19967 == null)){
} else {
var key_19968 = temp__4661__auto___19967;
...
var G__19970 = (new reagent.impl.template.NativeWrapper());
(G__19970["name"] = c);
...
var len__19529__auto___19976 = arguments.length;
var i__19530__auto___19977 = (0);
while(true){
if((i__19530__auto___19977 < len__19529__auto___19976)){
args__19536__auto__.push((arguments[i__19530__auto___19977]));

var G__19978 = (i__19530__auto___19977 + (1));
i__19530__auto___19977 = G__19978;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19537__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq19974){
var G__19975 = cljs.core.first.call(null,seq19974);
var seq19974__$1 = cljs.core.next.call(null,seq19974);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__19975,seq19974__$1);
});
...
break;
default:
var G__19982 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__19982;
continue;
...
var n__19374__auto___19985 = a.length;
var i_19986 = (0);
while(true){
if((i_19986 < n__19374__auto___19985)){
(a[i_19986] = reagent.impl.template.as_element.call(null,(a[i_19986])));

var G__19987 = (i_19986 + (1));
i_19986 = G__19987;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19374__auto___19988 = a.length;
var i_19989 = (0);
while(true){
if((i_19989 < n__19374__auto___19988)){
var val_19990 = (a[i_19989]);
if((cljs.core.vector_QMARK_.call(null,val_19990)) && ((reagent.impl.template.key_from_vec.call(null,val_19990) == null))){
(o["no-key"] = true);
} else {
}

(a[i_19989] = reagent.impl.template.as_element.call(null,val_19990));
...
var ctx = {};
var vec__19993 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__19993,(0),null);
var derefed = cljs.core.nth.call(null,vec__19993,(1),null);
...
var G__19995 = (cljs.core.count.call(null,argv) - first_child);
switch (G__19995) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__19995){
...
//# sourceMappingURL=template.js.map?rel=1471014447489