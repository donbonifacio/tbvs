...
var x__19122__auto__ = (((x == null))?null:x);
var m__19123__auto__ = (sablono.util.to_str[goog.typeOf(x__19122__auto__)]);
if(!((m__19123__auto__ == null))){
return m__19123__auto__.call(null,x);
} else {
var m__19123__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__19123__auto____$1 == null))){
return m__19123__auto____$1.call(null,x);
} else {
...
var x__19122__auto__ = (((x == null))?null:x);
var m__19123__auto__ = (sablono.util.to_uri[goog.typeOf(x__19122__auto__)]);
if(!((m__19123__auto__ == null))){
return m__19123__auto__.call(null,x);
} else {
var m__19123__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__19123__auto____$1 == null))){
return m__19123__auto____$1.call(null,x);
} else {
...
var len__19529__auto___24667 = arguments.length;
var i__19530__auto___24668 = (0);
while(true){
if((i__19530__auto___24668 < len__19529__auto___24667)){
args__19536__auto__.push((arguments[i__19530__auto___24668]));

var G__24669 = (i__19530__auto___24668 + (1));
i__19530__auto___24668 = G__24669;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__19537__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq24666){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24666));
});
/**
...
var vec__24671 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__24671,(0),null);
var words = cljs.core.nthnext.call(null,vec__24671,(1));
...
var G__24673 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__24673,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__24673;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__24674_SHARP_){
if(typeof p1__24674_SHARP_ === 'string'){
return p1__24674_SHARP_;
} else {
return cljs.core.seq.call(null,p1__24674_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__18459__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1471010643263