...
var args26125 = [];
var len__19529__auto___26129 = arguments.length;
var i__19530__auto___26130 = (0);
while(true){
if((i__19530__auto___26130 < len__19529__auto___26129)){
args26125.push((arguments[i__19530__auto___26130]));

var G__26131 = (i__19530__auto___26130 + (1));
i__19530__auto___26130 = G__26131;
continue;
} else {
}
break;
...
var G__26128 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__26128,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__26128;
}
});
...
var or__18459__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__19529__auto___26136 = arguments.length;
var i__19530__auto___26137 = (0);
while(true){
if((i__19530__auto___26137 < len__19529__auto___26136)){
args__19536__auto__.push((arguments[i__19530__auto___26137]));

var G__26138 = (i__19530__auto___26137 + (1));
i__19530__auto___26137 = G__26138;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__19537__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq26133){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__26134,G__26135,seq26133__$2);
});
...
var file = cljs.core.get.call(null,map__26142__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26142__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26142__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__26142,map__26142__$1,file,line,column){
return (function (p1__26139_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__26139_SHARP_));
});})(map__26142,map__26142__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__19384__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__19384__auto__,prefer_table__19385__auto__,method_cache__19386__auto__,cached_hierarchy__19387__auto__,hierarchy__19388__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__18459__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__18459__auto__)){
return or__18459__auto__;
} else {
...
var temp__4657__auto___26144 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26144)){
var message_26145 = temp__4657__auto___26144;
cljs.core.println.call(null,message_26145);
} else {
}
...
var temp__4657__auto___26146 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___26146)){
var message_26147 = temp__4657__auto___26146;
cljs.core.println.call(null,message_26147);
} else {
}
...
var temp__4655__auto__ = (function (){var and__18447__auto__ = typeof exception.stack === 'string';
if(and__18447__auto__){
var G__26153 = exception.stack;
var G__26153__$1 = (((G__26153 == null))?null:clojure.string.split_lines.call(null,G__26153));
var G__26153__$2 = (((G__26153__$1 == null))?null:cljs.core.get.call(null,G__26153__$1,depth));
if((G__26153__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__26153__$2);
}
} else {
...
var vec__26154 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__26154,(0),null);
var column = cljs.core.nth.call(null,vec__26154,(1),null);
var vec__26155 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__26155,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__26155,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__26155,(2),null);
...
var m__$1 = (function (){var G__26157 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__26157) {
case "fail":
...
var G__26163 = (function (){var G__26162 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__26162);
} else {
return G__26162;
}
})();
...
return cljs.core.vary_meta.call(null,G__26165,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e26168){var e = e26168;
var G__26169 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__26169) {
...
var vec__26172 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__26172,(0),null);
var types = vec__26172;
...
return cljs.core.map.call(null,(function (p__26180){
var vec__26181 = p__26180;
var ns = cljs.core.nth.call(null,vec__26181,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__26181,(1),null);
return ((function (vec__26181,ns,vars__$1){
return (function (){
...
var G__26182 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__26182) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__26182,env,once_fixtures,each_fixtures,vec__26181,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__26182,env,once_fixtures,each_fixtures,vec__26181,ns,vars__$1){
return (function (){
var seq__26183 = cljs.core.seq.call(null,vars__$1);
var chunk__26184 = null;
var count__26185 = (0);
var i__26186 = (0);
while(true){
if((i__26186 < count__26185)){
var v = cljs.core._nth.call(null,chunk__26184,i__26186);
var temp__4657__auto___26188 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26188)){
var t_26189 = temp__4657__auto___26188;
each_fixture_fn.call(null,((function (seq__26183,chunk__26184,count__26185,i__26186,t_26189,temp__4657__auto___26188,v,each_fixture_fn,G__26182,env,once_fixtures,each_fixtures,vec__26181,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26189)));
});})(seq__26183,chunk__26184,count__26185,i__26186,t_26189,temp__4657__auto___26188,v,each_fixture_fn,G__26182,env,once_fixtures,each_fixtures,vec__26181,ns,vars__$1))
);
} else {
}

var G__26190 = seq__26183;
var G__26191 = chunk__26184;
var G__26192 = count__26185;
var G__26193 = (i__26186 + (1));
seq__26183 = G__26190;
chunk__26184 = G__26191;
count__26185 = G__26192;
i__26186 = G__26193;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__26183);
if(temp__4657__auto__){
var seq__26183__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__26183__$1)){
var c__19270__auto__ = cljs.core.chunk_first.call(null,seq__26183__$1);
var G__26194 = cljs.core.chunk_rest.call(null,seq__26183__$1);
var G__26195 = c__19270__auto__;
var G__26196 = cljs.core.count.call(null,c__19270__auto__);
var G__26197 = (0);
seq__26183 = G__26194;
chunk__26184 = G__26195;
count__26185 = G__26196;
i__26186 = G__26197;
continue;
} else {
var v = cljs.core.first.call(null,seq__26183__$1);
var temp__4657__auto___26198__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___26198__$1)){
var t_26199 = temp__4657__auto___26198__$1;
each_fixture_fn.call(null,((function (seq__26183,chunk__26184,count__26185,i__26186,t_26199,temp__4657__auto___26198__$1,v,seq__26183__$1,temp__4657__auto__,each_fixture_fn,G__26182,env,once_fixtures,each_fixtures,vec__26181,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26199)));
});})(seq__26183,chunk__26184,count__26185,i__26186,t_26199,temp__4657__auto___26198__$1,v,seq__26183__$1,temp__4657__auto__,each_fixture_fn,G__26182,env,once_fixtures,each_fixtures,vec__26181,ns,vars__$1))
);
} else {
}

var G__26200 = cljs.core.next.call(null,seq__26183__$1);
var G__26201 = null;
var G__26202 = (0);
var G__26203 = (0);
seq__26183 = G__26200;
chunk__26184 = G__26201;
count__26185 = G__26202;
i__26186 = G__26203;
continue;
}
} else {
...
});})(each_fixture_fn,G__26182,env,once_fixtures,each_fixtures,vec__26181,ns,vars__$1))
);
});})(each_fixture_fn,G__26182,env,once_fixtures,each_fixtures,vec__26181,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1471010644569